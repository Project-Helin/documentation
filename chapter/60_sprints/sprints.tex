...
\begin{figure}[H]
	\includegraphics[width=0.9\textwidth] {chapter/60_sprints/sprint-5-completed.png}
	\caption{Abgeschlossene Tasks in Sprint 5}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.9\textwidth] {chapter/60_sprints/sprint-5-not-completed.png}
