...
\subsubsection{Test}
Es sollten alle public Methoden, soweit diese nicht trivial sind, getestet werden. Falls der automatisch Testaufwand zu gross ist, kann dieser auch manuell getestet werden.
