...
In der Architektur wurde entschieden, dass zur Kommunikation zwischen Server und Drohne ein \Gls{Message Broker} verwendet wird. Das genaue Produkt wurde allerdings noch nicht festgelegt. Folgende Broker wurden evaluiert:  \\
