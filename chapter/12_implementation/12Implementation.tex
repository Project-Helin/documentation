...
\\
Die Verbindung zum RabbitMQ läuft über TLS (Transport Layer Security ). Das Customer App meldet sich über einen hard-codeten Benutzernamen und Passwort beim RabbitMQ an. 
...
Über diesen Kanal werden JSON Messages ausgetauscht. Ein Angreifer müsste den Token herausfinden. Mit einer Brutforce Methode ist dies mit $2^122$ Möglichkeiten ein Treffer auszuschliessen. 
