...
\begin{tabularx}{\textwidth}{|l|X|X|X|}
	...
	\hline
	\textbf{Vorteile} & 
	\begin{itemize}[noitemsep, topsep=1pt, wide = 1em] \item{API Dokumentation} \item{Android Support} \end{itemize}  & 
	\begin{itemize}[noitemsep, topsep=1pt, wide = 1em] \item{Opensource} \item{Automatische  Verbindungswiederherstellung} \end{itemize}  &
	\begin{itemize}[noitemsep, topsep=1pt, wide = 1em] \item{Opensource} \end{itemize} \\
	
	\hline 
	
	
	\textbf{Nachteile} & 
	\begin{itemize}[noitemsep, topsep=1pt, wide = 1em] \item{Kostenpflichtig \footnote{ab 100 Verbindungen}} \item{Android Support} \end{itemize}  & 
	\begin{itemize}[noitemsep, topsep=1pt, wide = 1em] \item{Betrieb on premisies} \item{Automatische  Verbindungswiederherstellung} \end{itemize}  &
	\begin{itemize}[noitemsep, topsep=1pt, wide = 1em] \item{Opensource} \end{itemize} \\
...
Sollte die Verbindung zwischen Server und Onboard-App unterbrochen sein, sollte wenn möglich verhindert werden, dass Nachrichten verloren gehen. Bei unterbrochener Verbindung wird dies wie folgt erreicht:\\
\begin{itemize}
...
\end{itemize}
Mit diesen Massnahmen haben wir einen guten Kompromiss zwischen Zuverlässigkeit und Implementationsaufwand erreicht.
}
