...
\begin{itemize}
	...
	\item Hat Unterschiedlicher Latenzen gemäss Erfrahungsbericht \ref{gcm-latenc}
\end{itemize}
...
\begin{itemize}
	...
	\item Kann Verbindung wiederherstellen bei Unterbrüche
\end{itemize}
...
Aufgrund unserer Anforderungen dass vom Android aus auf den Messaging Broker verbunden werden kann, und beim Verbindungsunterbrüche keine negativen Auswirkung haen sollten, kam nur RabbitMQ in Frage.
