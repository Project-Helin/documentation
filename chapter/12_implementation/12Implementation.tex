...
\subsubsection{Code}
Für die Formattierung und Static Check wird IntellJ verwendet. Dabei werden die Inspection von IntelliJ IDEA verwendet.
Deise sind konfigurierbare Regeln, welche mit dem Projekt eingecheckt werden. Der IDE führt diese vor dem eincheck aus.

Als vorlage wurden die Standardregeln genommen und angepasst. Dabei sind folgende Regeln enthaltne:
\begin{itemize}
	\item{Unused Code: Zum Beispiel Import, Methode oder Variable}
\end{itemize}
