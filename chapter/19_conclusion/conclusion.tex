...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth] {images/drone3.jpg}
	\caption{Zweite Drohne in der finalen Ausbaustufe}
\end{figure}
...
\begin{itemize}
	...
	\item Zugang zum Broker besser absichern (Zertifikate)
\end{itemize}
