...
%\begin{figure}
\includegraphics[width=0.95\textwidth]{images/persona-diego.jpg}
...
\begin{figure}[h]
	...
	\caption{Persona Ricardo: Freie Lizenz; Quelle} %\url{http://blog.placeit.net/free-avatar-pack/}}
	\label{fig:ricardo}
\end{figure}
...
Sie kommuniziert geschäftlich hauptsächlich per E-Mail. Mit Freunden unterhält sie sich oft über WhatsApp.
\paragraph{Ziele}
Ricardo möchte noch im kommenden Jahr als Matrose auf einem Kreuzfahrtschiff anheuern und so die Welt entdecken.
