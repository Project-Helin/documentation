...
\\
Abschliessend kann man aus den Tragfähigkeitstests sagen, dass der in der Aufgabenstellung erwähnte Defibrilator mit einer Drohne auslieferbar wäre.
...
\cite[p.3]{FleckUAV}
Diese Aussage unterstreicht unsere Abstraktion mit der PET-Flasche. Die PET-Flasche wiegt etwas über 500g, was in einem genügenden Umfang aufzeigt, dass der kleinste Defibrilator transportierbar wäre. Weiter wird in dem zitierten Paper ein zweiter Defibrilator erwähnt, dieser wiegt 1100 Gramm und hatte bessere Usability, welche in folgendem Abschnitt erwähnt wurde
\blockquote{For the Heartsine unit, performance was much better: only 8\% of participants (1 out of 13; p=.05) failed to deliver a shock, and usability problems added on average 22 seconds delay, better than the Schiller (p=.02).}
\cite[p.4]{FleckUAV}
An dieser Stelle haben wir nur kurze Versuche mit Gewichten im Bereich von 1000g erfolgreich absolviert. Es wurde bewusst nicht weiter dokumentiert, da die Usability eines Defibrilators nicht Teil des Arbeitsumfangs war. Aufgrund der Erkenntnisse kann aber davon ausgegangen werden, dass ein Defibrilator unter 1000g auf den verfügbaren Drohnen auslieferbar wäre.