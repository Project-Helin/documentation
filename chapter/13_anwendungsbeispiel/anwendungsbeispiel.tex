...
Nach dem manuellen Flug und der Konfiguration vom Pixhawk wurde versucht das Smartphone zu montieren. 
Uns wurde klar, dass eine Befestigung Mechanismus für das Smartphone erarbeitet werden mussten. 
Denn auf dem Pixhawk konnte es nicht montiert, da die Display für den Benutzer sichtbar sein musste, wurde ein Halterung erarbeitet und mit einm 3D-Drucker hergestellt.
