...
Beide Alternativen bringen zusätzlich mit sich, dass sie nicht autonom betrieben werden. Somit muss auf die Bordstromversorgung zurückgegriffen werden und das \Gls{BEC} für die Servo-Stromversorgung verwendet werden muss um eine stabile Betriebsspannung zu generieren. \\

Abschliessend kann gesagt werden, dass die Mobiltelefonlösung mit dem von uns verwendeten Nexus 4 ein Gewicht von 139 Gramm mit sich bringt. Die Lösung mit dem Raspberry PI 3 schlägt 40 Gramm zu buche. Die Einsparung von 100 Gramm bringt einen Verzicht auf ein Display und eine autonome Batterie mit sich. Es ist hier von use-case zu use-case zu entscheiden, ob dieser Kompromiss angebracht ist. Auf einen Kostenpunktsvergleich verzichten wir an dieser Stelle, da gebrauchte Android Smartphones in einer erschwinglichen Preisregion angesiedelt sind.
