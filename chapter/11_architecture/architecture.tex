...
Die Architektur des Servers basiert auf dem MVC Pattern, da dieses für CRUD Applikationen besonders geeignet ist und dafür viele geeignete Frameworks zur Verfügung stehen.
 ...
 Für Funktionen die aus unterschiedlichen Controllern verwendet werden, wurde zustäzlich zu Gunsten eines Service Packages entschieden. Die Services stellen unter anderem eine Abstaktionsschicht für das Messaging bereit und ermöglichen ebenfalls die Routeberechnungsalgorithmen seperat zur Business-Logik auszulagern.

 %TODO Referenz auf Literaturverzeichnis für MVC
