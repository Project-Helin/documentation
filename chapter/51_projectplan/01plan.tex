...
Die Tests wurden nach den drei Komponenten Administrations-Seite, OnBoard-App und dem Customer-App aufgeteilt. 
...
\begin{todolist}
	...
	\item[\xmark] Administrator kann eine Bestellung ändern ( Funtkionale Anforderung ) %TODO
	\item[\xmark] Administrator kann eine Bestellung löschen ( Funtkionale Anforderung ) %TODO
	...
	\item[\xmark] Administrator kann Services definieren ( Funktioanle Anforderung ) %TODO optional
...
\begin{todolist}
	...
	\item[\done] Bevor die Drohne startet erhaltn ich ein Countdown
...
\subsubsection{Funktionale Anforderungen}	
\begin{todolist}
	\item[\xmark] Der Kunde kann sich die App aus dem Google Play Store herunterladen %TODO Xmark
	...
	\item[\xmark] Als Kunde kann ich  eine Bestellung stornieren %ODO xmark
\end{todolist}
