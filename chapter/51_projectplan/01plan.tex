...
\begin{itemize}
	\item Server: www.helin.ch
	\item On-Board-App: läuft auf einem Nexus 5 mit Android 6.0
	\item Customer-App: läuft auf einem Neuxs 5 mit Android 6.1
	\item Drohne: läuft im Simulator
\end{itemize}
...
\begin{todolist}
	...
	\item[\done] Administraotr kann die Bestellung ansehen.
	...
	\item[\done] Adminstraot kann die Missionen pro Bestllung ansehen
	\item[\xmark] Administrator kann einbe Bestellunge ändern ( Funtkionale Anforderung )
	\item[\xmark] Administrator kann einbe Bestellunge löschen ( Funtkionale Anforderung )

	\item[\xmark] Drone kann herausgelöscht werden (Funktionale Anforderung)
	\item[\xmark] Adminstrator kann eine laufende Mission abbrechen
...
\begin{todolist}
	\item[\done] Auf die Admin Seite kann nur über HTTPS zugegriffen werden
\end{todolist}
...
\begin{todolist}
	...
	\item[\done] Das OnBoard-App kann sich mit der Drohne verbinden
	...
	\item[\xmark] Bevor dei Drohne startet erhalte ich einen akustischen Signal
...
\begin{todolist}
	...
	\item[\done] Die Verbindugm zum Server bei der Übertragung der Drohneninformation ist verschlüsselt (überprüft mittels RabbitMQ Management Konsole)
\end{todolist}

\subsection{Customer}	
\subsubsection{Funktionale Anforderungen}	
\begin{todolist}
	\item[\xmark] Der Kunde kannn sich die App aus dem Google Play Store herunterladen
