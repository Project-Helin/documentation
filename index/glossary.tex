...
\newglossaryentry{MOM}{
    ...
    description=Eine Abstraktionsschicht zur Kommunikation zwischen Systemen
}
...
\newglossaryentry{DBMS}{
	name=DBMS,
	description={Ein DBMS (Database Management System) dient zur Verwaltung und zur Abfrage einer Datenbank. Bekannte Systeme sind Oracle, MSSQL und PostgreSQL}
}
